...
class ModelUltiHANVAEtm(ModelUltiVAEtm):
    ...
    def train(self, trainBatchIter, num_epohs=100, valBatchIter=None, cache_path=None, earlyStopping='cls_loss', patience=5):
        ...
        classifier_paramters = list(self.net.wv_hidden.parameters()) + list(self.net.wv_classifier.parameters()) + list(self.net.doc_level_att.parameters())# + list(self.net.sent_encoder.parameters())
