...
from WvMLLib import modelUlti
from WvMLLib import PostProcessorBaseline as ReaderPostProcessor
from WvMLLib.models import BERT_ATT as BERT_Simple
...
if __name__ == "__main__":
    ...
    postProcessor = ReaderPostProcessor(tokenizer='bert', config=config, word2id=True, remove_single_list=False, add_spec_tokens=False)
    ...
    for each_fold in kf.split(all_ids):
        ...
        mUlti.train(trainBatchIter, cache_path=fold_cache_path, num_epohs=150)
