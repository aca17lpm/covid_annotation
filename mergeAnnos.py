...
if __name__ == "__main__":
    ...
    parser.add_argument("--logging_level", default='warning', help="logging level")
    parser.add_argument("--user_conf", default=None, help="User level confident cutoff thres")
    parser.add_argument("--set_reverse", default=False, action='store_true', help="reverse the selection condition")
